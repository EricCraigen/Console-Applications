 ...
 *  Name:         Eric Craigen
 *  Date:         5/4/2020
 *  Assignment:   Week 4 Project: Rock Paper Scissors
 *  Class Number: 282
 *  Description:  Game of RPS against the computer
 ************************************************************/
fun main() {

    // Introduce the game, display the rules of the game, and ask the user if they would like to play the game
    println( "Welcome to Rock-Paper-Scissors!" )
    println( "This is a simple game of choosing one of either Rock, Paper, or Scissors against the computers choice" )
        ...
        if ( playResult == "y" || playResult == "Y" ) {
            ...
            do {
                ...
                when ( userChoice ) {
                    ...
                    // Else the user choice is anything other than 1-3
                    else -> {
                        // If user choice does not equal 4
                        if ( userChoice != 4 ) {
                ...
                // While the user choice variable is not 4 restart the loop
            } while ( userChoice != 4 )
